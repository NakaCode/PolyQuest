...
STRINGS: dict = {
    "pt": {
        ...
        "ai_section":                   "MODO IA",
        "ai_enable":                    "Traduzir com IA",
        "ai_provider_label":            "Provedor:",
        "ai_key_label":                 "API key:",
        "ai_key_placeholder":           "cole sua chave de API",
        "ai_hint":                      "Usa sua própria chave (fica só neste computador). A IA entende contexto de jogos; se falhar, o Google Translate assume.",
    ...
    "en": {
        ...
        "ai_section":                   "AI MODE",
        "ai_enable":                    "Translate with AI",
        "ai_provider_label":            "Provider:",
        "ai_key_label":                 "API key:",
        "ai_key_placeholder":           "paste your API key",
        "ai_hint":                      "Uses your own key (stored only on this computer). The AI understands game context; if it fails, Google Translate takes over.",
    ...
    "es": {
        ...
        "ai_section":                   "MODO IA",
        "ai_enable":                    "Traducir con IA",
        "ai_provider_label":            "Proveedor:",
        "ai_key_label":                 "API key:",
        "ai_key_placeholder":           "pega tu clave de API",
        "ai_hint":                      "Usa tu propia clave (se guarda solo en este equipo). La IA entiende contexto de juegos; si falla, Google Translate asume.",
        "settings_section_languages":   "IDIOMAS",
